...
(defn search-yt [search-term]
  "Search for term in youtube and return first youtube url using
yts https://github.com/lepisma/cfg/blob/master/scripts/bin/yts"
  (let [proc (sp.run ["yts" search-term] :stdout sp.PIPE)]
    (+ "https://youtube.com/watch?v=" (first (.splitlines (proc.stdout.decode "utf-8"))))))
